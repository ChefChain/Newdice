...
const Calendar = () => {
  return (
    <div className="mx-auto max-w-7xl">
      ...
      <div className="w-full max-w-full rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-background">
        <table className="w-full">
          <thead>
            <tr className="grid grid-cols-7 rounded-t-sm bg-background text-white">
