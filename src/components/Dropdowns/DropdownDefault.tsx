  ...
  return (
    <div className="relative flex">
      ...
      <div
        ...
        className={`dark:bg-background absolute right-0 top-full z-40 w-40 space-y-1 rounded-sm border border-stroke bg-white p-1.5 shadow-default dark:border-strokedark ${
