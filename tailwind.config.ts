  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        ...
        "primary-gradient":
          "linear-gradient(180deg, hsl(var(--primary)) 0%, 	rgb(100, 92, 255) 100%)",
      },
      content: {
      ...
      animation: {
        ...
        blinkBorderSuccess: "blinkBorderSuccess 1.5s infinite",
        blinkBorderError: "blinkBorderError 1.5s infinite",
        blinkButton: "blinkButton 1.5s infinite",
      },
    },
  },
